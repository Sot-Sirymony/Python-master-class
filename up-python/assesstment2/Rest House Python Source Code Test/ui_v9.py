...
#     QLineEdit, QPushButton, QTableWidget, QTableWidgetItem, QMessageBox, QStatusBar, QHeaderView, QDialog
# )
from PyQt6.QtWidgets import (
    QApplication, QMainWindow, QTabWidget, QWidget, QVBoxLayout, QLabel,
    QLineEdit, QPushButton, QTableWidget, QTableWidgetItem, QMessageBox,
    QStatusBar, QHeaderView, QDialog, QInputDialog  # Add QInputDialog here
)
