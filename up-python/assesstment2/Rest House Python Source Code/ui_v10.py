...
class RestHouseApp(QMainWindow):
    ...
    def add_guest_tab(self):
        ...
        add_guest_button.setIcon(QIcon(":/icons/add_user.png"))  # Placeholder icon
    ...
    def list_guests_tab(self):
        ...
        refresh_button.setIcon(QIcon(":/icons/refresh.png"))  # Placeholder icon
        refresh_button.clicked.connect(self.display_guests)
        layout.addWidget(refresh_button)

        delete_button = QPushButton("Delete Selected Guest")
        delete_button.setIcon(QIcon(":/icons/delete_user.png"))  # Placeholder icon
    ...
    def make_reservation_tab(self):
        ...
        # Buttons for Making Reservation
        make_reservation_button = QPushButton("Make Reservation")
        make_reservation_button.setIcon(QIcon(":/icons/add_reservation.png"))  # Placeholder icon
    ...
    def reservation_overview_tab(self):
        ...
        delete_button.setIcon(QIcon(":/icons/delete_reservation.png"))  # Placeholder icon
