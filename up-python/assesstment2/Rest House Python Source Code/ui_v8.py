...
from rest_house_manager_v3 import RestHouseManager
import csv
import re
...
class RestHouseApp(QMainWindow):
    ...
    def add_pagination_controls(self, layout, data, table_widget):
        previous_button = QPushButton("Previous")
        next_button = QPushButton("Next")

        previous_button.clicked.connect(lambda: self.previous_page(data, table_widget))
        next_button.clicked.connect(lambda: self.next_page(data, table_widget))
    ...
    # Other tabs implemented similarly...
